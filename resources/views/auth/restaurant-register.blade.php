            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ action('RestaurantRegistrationController@register') }}">
                        ...
                        <div class="form-group row">
                          <label for="restaurant_city" class="col-md-4 col-form-label text-md-right">{{ __('Restaurant city') }}</label>
                          <div class="col-md-6">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <textarea name="restaurant_description" cols="45" rows="10"></textarea>
                          </div>
                        </div>
